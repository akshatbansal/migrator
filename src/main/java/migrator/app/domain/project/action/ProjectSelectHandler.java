...
public class ProjectSelectHandler implements EventHandler {
    private ProjectStore projectStore;

    public ProjectSelectHandler(ProjectStore projectStore) {
        this.projectStore = projectStore;
    }

    @Override
    public void handle(Event<?> event) {
        this.projectStore.select((Project) event.getValue());
    }
}